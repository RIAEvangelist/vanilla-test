 ...
 *
 * Options: executablePath (string|null), headless (boolean), timeoutMs,
 * signal, viewport ({width,height}), args (additional Chrome flags), env, cwd.
...
export async function launchChrome(options = {}) {
    ...
    const reserved = /^(--remote-debugging-|--user-data-dir(?:=|$)|--headless(?:=|$))/;
