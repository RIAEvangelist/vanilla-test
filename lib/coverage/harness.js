...
.console-reminder { margin: 18px 0 0; color: #bfead7; font: 600 13px/1.5 system-ui, sans-serif; }
...
<main data-vanilla-test-status data-ok="pending">
  ...
  <p class="console-reminder"><strong>Check the console or DevTools</strong> for the complete test output.</p>
</main>
<script type="module">
